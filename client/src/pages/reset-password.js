              ...
              InputProps={{
                endAdornment: (
                  <InputAdornment position="end">
                    ...
                    >
                      {showNewPassword ? <Icon icon="tabler:eye-off" /> : <Icon icon="tabler:eye" />}
                    </IconButton>
                  </InputAdornment>
                ),
              }}
                ...
                endAdornment: (
                  <InputAdornment position="end">
                    <IconButton
                      ...
                      onMouseDown={e => e.preventDefault()}
                    >
                      {showConfirmNewPassword ? <Icon icon="tabler:eye-off" /> : <Icon icon="tabler:eye" />}
                    </IconButton>
                  </InputAdornment>
                ),
              }}
...
ResetPasswordWithToken.getLayout = page => <BlankLayout>{page}</BlankLayout>;
ResetPasswordWithToken.guestGuard = true;
